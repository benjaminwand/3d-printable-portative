...
move_c = [10, 40 + end_of_keyboard, 1.5 + z2];
move_cis = [27, end_of_keyboard, 1.5 + z1];
move_d = [42.5, 38 + end_of_keyboard, 1.5 + z2];
move_dis = [57, end_of_keyboard, 1.5 + z1];
move_e = [72.5, 36 + end_of_keyboard, 1.5 + z2];
move_f = [85, end_of_keyboard, 1.5 + z1];
move_fis = [100, 34 + end_of_keyboard, 1.5 + z2];
move_g = [112.5, end_of_keyboard, 1.5 + z1];
move_gis = [124.5, 32 + end_of_keyboard, 1.5 + z2];
move_a = [137.5, end_of_keyboard, 1.5 + z1];
move_ais = [147, 30 + end_of_keyboard, 1.5 + z2];
move_h = [160, end_of_keyboard, 1.5 + z1];
move_c1 = [169, 28 + end_of_keyboard, 1.5 + z2];
...
outerDiameter = [/*c*/ 30,/*cis*/ 30,/*d*/ 30,/*dis*/ 25,/*e*/ 25,/*f*/ 25,
    /*fis*/ 25,/*g*/ 25,/*gis*/ 20,/*a*/ 20,/*ais*/ 20,/*h*/ 20,/*c1*/ 20]; 
...
flueSteps = [/*c*/ 19,/*cis*/ 20,/*d*/ 21,/*dis*/ 16,/*e*/ 16,/*f*/ 20,
    /*fis*/ 17,/*g*/ 16,/*gis*/ 17,/*a*/ 24,/*ais*/ 21,/*h*/ 21,/*c1*/ 21]; // only works well for few values, pay attention !!
...
air_supply_diameter = [for (i = [0: (len(name) - 1)])innerDiameter[i] * 0.15 + 3.5]; 
...
pipeInsert = [for (i = [0: (len(name) - 1)])lengthFlue[i]]; 
...
rainbow (lower_outer_labium_cut[1]);
